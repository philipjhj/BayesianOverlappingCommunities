function [logprob,NZQ,suff_stats] = logjoint_opt_2_hyper(A,Z,Q,pms,suff_stats,mode,idx,NZQ,M_prev)
...
elseif mode(1) == 'z'
    ...
    suff_stats.betasuff_AZQ = betaintegral_noverbose(suff_stats.NPaps,suff_stats.NPams,suff_stats.NPbps,suff_stats.NPbms);
...
elseif mode(1) == 'q'
    ...
    suff_stats.betasuff_AZQ(j) = betaintegral_noverbose(suff_stats.NPaps(j),suff_stats.NPams(j),suff_stats.NPbps(j),suff_stats.NPbms(j));
    %b1 = betaln(pms(3,1),pms(3,2))+betaln(pms(4,1),pms(4,2));
    suff_stats.betasuff_sums(d) = betaln(suff_stats.NZp(d),suff_stats.NZm(d))+betaln(suff_stats.NQp(d),suff_stats.NQm(d));
    %b2 = betaln(pms(1,1),pms(1,2))+betaln(pms(2,1),pms(2,2));
else
