...
%%%%%%%% remove this
Z{1}=sparse(1:size(Z{1},2),1:size(Z{1},2),ones(1,size(Z{1},2)));
noc(1)=size(Z{1},1);
...
while iter<maxiter
    ...
    % sample eta0        
    [logP_A,eta0]=sample_eta0(Z{k},Zm,eta0,par);           
...
for sample_iter=1:max_iter  
 ...
 %--------------------------------------------------------------------
function [logP,eta0]=sample_eta0(Z1,Z2,eta0,par) 
